...
这是《红楼梦》的 Obsidian Wiki，包含 120 回繁简原文、人物、事件、概念、红学研究与 AI 插图。当前数量以 [WIKI_STATUS.md](WIKI_STATUS.md) 为唯一快照。
...
| 人物 | 106 | 核心人物、管理权力、丫鬟群像、外部视角、旁系、红学家/批书人 |
| 事件 | 181 | 按叙事功能分组，含事件经过、章节、叙事作用 |
| 概念 | 38 | 情、空、梦、真假、薄命、礼法、婚姻、护官符等 |
| 地点 | 21 | 大观园、荣国府、宁国府、太虚幻境等 |
| 诗词 | 12 | 判词、曲文、葬花吟、芙蓉女儿诔、好了歌等 |
| 红学专题 | 53 | 综述、精读、红学家/批书人与证据规范 |
...
| 输出产品 | 14 | 速读指南、人物手册、主题导读、人物关系阅读指南、大观园空间手册、维护审查等 |
| raw 原始文本 | 121 | 原始文本层，单独统计，不并入成品总计 |
| **成品+raw 管理口径** | **952** | 仅用于维护统计 |
| **总计** | **831** | 成品 Wiki Markdown 文件，不含 `raw/` |

注：`831` 是成品 Wiki Markdown 口径；`raw/` 下 `121` 个原始文本 Markdown 只作为原始文本层单独统计。本轮按方案 C 不改变 `raw/` 的 Git 管理策略。
