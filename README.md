...
这是《红楼梦》的 Obsidian Wiki，包含 120 回全文（繁简双版本）、106 个人物页、181 个事件页、38 个概念页、52 个红学专题综述，以及 26 张 AI 插图。
...
| **成品+raw 管理口径** | **950** | 仅用于维护统计 |
| **总计** | **829** | 成品 Wiki Markdown 文件，不含 `raw/` |

注：`829` 是成品 Wiki Markdown 口径；`raw/` 下 `121` 个原始文本 Markdown 只作为原始文本层单独统计。本轮按方案 C 暂不改变 `raw/` 的 Git 管理策略。
